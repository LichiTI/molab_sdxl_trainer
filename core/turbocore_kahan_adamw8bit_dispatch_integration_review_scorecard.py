"""Review-only gate for KahanAdamW8bit real dispatch integration."""

from __future__ import annotations

from typing import Any, Mapping, Sequence

from core.turbocore_kahan_adamw8bit_canary_rollout_policy_scorecard import (
...
REVIEW_KIND = "kahan_adamw8bit_dispatch_integration_review_v0"


def build_kahan_adamw8bit_dispatch_integration_review_scorecard(
    *,
    ...
    policy_report = dict(
        ...
        or build_kahan_adamw8bit_canary_rollout_policy_scorecard(
    ...
    return {
        "schema_version": 1,
        "scorecard": "turbocore_kahan_adamw8bit_dispatch_integration_review_scorecard_v0",
        "gate": "kahan_adamw8bit_dispatch_integration_review",
        "ok": ready,
        ...
        "recommended_next_step": (
            "requires explicit review before wiring KahanAdamW8bit real dispatch"
            if ready
            else "fix KahanAdamW8bit dispatch integration review blockers"
        ),
        "notes": [
            "This gate prepares a real-dispatch integration review only.",
            "Python KahanAdamW8bit remains the training update authority.",
...
def _review_package(policy_report: Mapping[str, Any], mode: str) -> dict[str, Any]:
    ...
    return {
        ...
        "dispatch_contract": {
            "fallback_update_authority": "python_kahan_adamw8bit",
            "native_update_authority": "none_until_review",
            "requires_training_tensor_binding": True,
            "requires_bf16_dtype_matrix": True,
            "requires_checkpoint_resume_adapter": True,
        ...
        "numeric_guardrails": {
            ...
            "kahan_comp_dtype": "fp32_required",
            "quantized_state_authority": "python_checkpoint_until_review",
        },
        "rollback_policy": {
            ...
            "rollback_on_dtype_matrix_mismatch": True,
        },
        "audit_fields": [
...
def _validations(policy_report: Mapping[str, Any], review: Mapping[str, Any]) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _validation(
            ...
            "kahan_adamw8bit_dispatch_review_hook_contract_missing",
        ),
        _validation(
            "dispatch_contract_requires_all_prior_evidence",
            bool(dispatch.get("requires_training_tensor_binding", False))
            and bool(dispatch.get("requires_bf16_dtype_matrix", False))
            and bool(dispatch.get("requires_checkpoint_resume_adapter", False))
            and bool(dispatch.get("requires_end_to_end_shadow_matrix", False)),
            "kahan_adamw8bit_dispatch_review_prior_evidence_missing",
        ),
        _validation(
            ...
            and numeric.get("kahan_comp_dtype") == "fp32_required",
            "kahan_adamw8bit_dispatch_review_numeric_guardrails_missing",
        ),
        _validation(
            ...
            and bool(rollback.get("rollback_on_dtype_matrix_mismatch", False)),
            "kahan_adamw8bit_dispatch_review_missing_rollback",
        ),
        _validation(
            ...
            "kahan_adamw8bit_dispatch_review_allows_dispatch_before_review",
        ),
        _validation(
...
__all__ = ["build_kahan_adamw8bit_dispatch_integration_review_scorecard"]
