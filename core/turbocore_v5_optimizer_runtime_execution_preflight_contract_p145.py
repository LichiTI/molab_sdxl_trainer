"""Optimizer runtime-execution preflight contract for TurboCore V5-P145."""
...
from core.turbocore_v5_optimizer_runtime_execution_preflight_specs_p145 import P145_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P145_READY_DECISION = SPEC.ready_decision
P145_BLOCKED_DECISION = SPEC.blocked_decision
P145_HOLD_DECISION = SPEC.hold_decision
P145_REJECTED_DECISION = SPEC.rejected_decision
P145_SCOPE = SPEC.scope
...
def build_v5_optimizer_runtime_execution_preflight_contract_p145(
    *,
    p144_optimizer_training_launch_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p144_optimizer_training_launch_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p144-optimizer-training-launch-execution-contract")
    ...
    report = build_v5_optimizer_runtime_execution_preflight_contract_p145(
        p144_optimizer_training_launch_execution_contract=_load_optional(
            args.p144_optimizer_training_launch_execution_contract
        ),
        optimizer_runtime_execution_preflight_evidence=_load_optional(
            args.optimizer_runtime_execution_preflight_evidence
        ),
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_runtime_execution_preflight_contract_p145",
]
