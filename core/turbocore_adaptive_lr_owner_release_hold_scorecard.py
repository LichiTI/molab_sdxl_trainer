"""Owner/release approval hold for built-in adaptive-LR canaries."""
...
HOLD_KIND = "adaptive_lr_owner_release_hold_v0"


def build_adaptive_lr_owner_release_hold_scorecard(
    *,
    dispatch_review_report: Mapping[str, Any] | None = None,
) -> dict[str, Any]:
    """Record the approval hold after dispatch review without enabling dispatch."""

    review_report = _as_dict(dispatch_review_report or build_adaptive_lr_dispatch_integration_review_scorecard())
    ...
    return {
        "schema_version": 1,
        "scorecard": "turbocore_adaptive_lr_owner_release_hold_scorecard_v0",
        "gate": "adaptive_lr_owner_release_hold",
        "ok": ready,
        ...
        "recommended_next_step": (
            "record explicit owner and release approval before adaptive-LR product dispatch wiring"
            if ready
...
def _hold_manifest(review_report: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "required_approval_artifacts": [
            ...
            "adaptive_lr_state_machine_rollback_acknowledgement",
        ],
...
def _validations(review_report: Mapping[str, Any], hold: Mapping[str, Any]) -> list[dict[str, Any]]:
    ...
    return [
        _validation(
            ...
            "adaptive_lr_dispatch_review_missing",
        ),
        _validation(
            "optimizer_set_complete",
            optimizer_types == EXPECTED_OPTIMIZERS,
            "adaptive_lr_owner_release_optimizer_set_incomplete",
        ),
        _validation(
        ...
        _validation(
            ...
            "adaptive_lr_owner_release_review_enabled_dispatch",
        ),
    ]
...
__all__ = ["HOLD_KIND", "build_adaptive_lr_owner_release_hold_scorecard"]
