"""Optimizer runtime-execution preflight contract for TurboCore V5-P105."""
...
from core.turbocore_v5_optimizer_runtime_execution_preflight_specs_p105 import P105_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P105_READY_DECISION = SPEC.ready_decision
P105_BLOCKED_DECISION = SPEC.blocked_decision
P105_HOLD_DECISION = SPEC.hold_decision
P105_REJECTED_DECISION = SPEC.rejected_decision
P105_SCOPE = SPEC.scope
...
def build_v5_optimizer_runtime_execution_preflight_contract_p105(
    *,
    p104_optimizer_training_launch_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p104_optimizer_training_launch_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p104-optimizer-training-launch-execution-contract")
    ...
    report = build_v5_optimizer_runtime_execution_preflight_contract_p105(
        p104_optimizer_training_launch_execution_contract=_load_optional(
            args.p104_optimizer_training_launch_execution_contract
        ),
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_runtime_execution_preflight_contract_p105",
]
