"""Optimizer native-dispatch execution contract for TurboCore V5-P147."""
...
from core.turbocore_v5_optimizer_native_dispatch_execution_specs_p147 import P147_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P147_READY_DECISION = SPEC.ready_decision
P147_BLOCKED_DECISION = SPEC.blocked_decision
P147_HOLD_DECISION = SPEC.hold_decision
P147_REJECTED_DECISION = SPEC.rejected_decision
P147_SCOPE = SPEC.scope
...
def build_v5_optimizer_native_dispatch_execution_contract_p147(
    *,
    p146_optimizer_runtime_dispatch_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p146_optimizer_runtime_dispatch_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p146-optimizer-runtime-dispatch-execution-contract")
    ...
    report = build_v5_optimizer_native_dispatch_execution_contract_p147(
        p146_optimizer_runtime_dispatch_execution_contract=_load_optional(
            args.p146_optimizer_runtime_dispatch_execution_contract
        ),
        optimizer_native_dispatch_execution_evidence=_load_optional(args.optimizer_native_dispatch_execution_evidence),
        optimizer_native_dispatch_execution_signed_review=_load_optional(args.optimizer_native_dispatch_execution_signed_review),
    )
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_native_dispatch_execution_contract_p147",
]
