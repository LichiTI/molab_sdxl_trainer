"""Optimizer native-dispatch execution contract for TurboCore V5-P131."""
...
from core.turbocore_v5_optimizer_native_dispatch_execution_specs_p131 import P131_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P131_READY_DECISION = SPEC.ready_decision
P131_BLOCKED_DECISION = SPEC.blocked_decision
P131_HOLD_DECISION = SPEC.hold_decision
P131_REJECTED_DECISION = SPEC.rejected_decision
P131_SCOPE = SPEC.scope
...
def build_v5_optimizer_native_dispatch_execution_contract_p131(
    *,
    p130_optimizer_runtime_dispatch_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p130_optimizer_runtime_dispatch_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p130-optimizer-runtime-dispatch-execution-contract")
    ...
    report = build_v5_optimizer_native_dispatch_execution_contract_p131(
        p130_optimizer_runtime_dispatch_execution_contract=_load_optional(
            args.p130_optimizer_runtime_dispatch_execution_contract
        ),
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_native_dispatch_execution_contract_p131",
]
