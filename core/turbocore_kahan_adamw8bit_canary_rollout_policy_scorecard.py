"""Default-off canary rollout policy for KahanAdamW8bit."""

from __future__ import annotations

from typing import Any, Mapping, Sequence

from core.turbocore_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard import (
    build_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard,
)


POLICY_KIND = "kahan_adamw8bit_canary_rollout_policy_v0"
OPTIMIZER_KIND = "kahan_adamw8bit"
OPTIMIZER_FAMILY = "adamw_quantized_kahan"


def build_kahan_adamw8bit_canary_rollout_policy_scorecard(
    *,
    ...
    shadow = dict(
        ...
        or build_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard(
    ...
    return {
        "schema_version": 1,
        "scorecard": "turbocore_kahan_adamw8bit_canary_rollout_policy_scorecard_v0",
        "gate": "kahan_adamw8bit_canary_rollout_policy",
        "ok": ready,
        ...
        "promotion_blockers": _dedupe(
            ...
            + [
                ...
                "kahan_adamw8bit_real_dispatch_wiring_missing",
            ]
        ),
        "blocked_reasons": blockers,
        "recommended_next_step": (
            "requires explicit review before wiring real KahanAdamW8bit canary dispatch"
            if ready
            else "fix KahanAdamW8bit canary rollout policy blockers"
        ),
        "notes": [
...
def _policy(shadow: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "required_preflight_gates": [
            "p8ab_e2e_shadow_training_matrix",
        ...
        "numeric_guardrails": {
            ...
            "max_absmax_diff": summary.get("max_absmax_diff"),
            "max_kahan_comp_diff": summary.get("max_kahan_comp_diff"),
            "max_loss_diff": summary.get("max_loss_diff"),
            "quantized_state_mismatch_count": summary.get("quantized_state_mismatch_count"),
        },
        "rollback_policy": {
...
def _validations(
    ...
    return [
        ...
        _validation(
            ...
            "kahan_adamw8bit_canary_rollout_policy_missing_rollback",
        ),
        _validation(
            ...
            "kahan_adamw8bit_canary_rollout_policy_enabled_dispatch",
        ),
        _validation(
            "default_behavior_unchanged",
            not bool(shadow.get("training_path_enabled", True))
            and not bool(shadow.get("default_behavior_changed", True)),
            "kahan_adamw8bit_canary_rollout_policy_changed_default_behavior",
        ),
    ]
...
__all__ = ["build_kahan_adamw8bit_canary_rollout_policy_scorecard"]
