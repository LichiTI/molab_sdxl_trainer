"""Report-only end-to-end shadow training matrix for KahanAdamW8bit."""
...
from core.turbocore_kahan_adamw8bit_runtime_dispatch_adapter_shadow_scorecard import (
    build_kahan_adamw8bit_runtime_dispatch_adapter_shadow_scorecard,
)
...
MATRIX_KIND = "kahan_adamw8bit_e2e_shadow_training_matrix_v0"
MATRIX_CASES = (
    {"case": "shadow_lora_block_fp32_4096", "numel": 4096, "dtype": torch.float32, "shadow_step_count": 2},
    {"case": "shadow_lora_block_bf16_4096", "numel": 4096, "dtype": torch.bfloat16, "shadow_step_count": 2},
    {"case": "shadow_lora_block_bf16_8192", "numel": 8192, "dtype": torch.bfloat16, "shadow_step_count": 2},
)


def build_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard(
    *,
    ...
    adapter = dict(
        adapter_report
        or build_kahan_adamw8bit_runtime_dispatch_adapter_shadow_scorecard(
    ...
    return {
        "schema_version": 1,
        "scorecard": "turbocore_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard_v0",
        "gate": "kahan_adamw8bit_e2e_shadow_training_matrix",
        "ok": ready,
        ...
        "recommended_next_step": (
            "add KahanAdamW8bit explicit canary rollout policy with default off"
            if ready
            else "fix KahanAdamW8bit e2e shadow training matrix blockers"
        ),
        "notes": [
            "Each case keeps the Python KahanAdamW8bit update authoritative and compares native on cloned tensors.",
...
def _safe_case(case: Mapping[str, Any], fn: Callable[[], dict[str, Any]]) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "blocked_reasons": [f"kahan_adamw8bit_e2e_shadow_training_case_failed:{type(exc).__name__}"],
...
def _validations(
    ...
    return [
        _validation(
            "p8aa_runtime_dispatch_adapter_shadow_ready",
            bool(adapter.get("runtime_dispatch_adapter_shadow_ready", False)),
            "kahan_adamw8bit_runtime_dispatch_adapter_shadow_missing",
        ),
        _validation(
            ...
            "kahan_adamw8bit_e2e_shadow_training_fallback_not_authoritative",
        ),
        _validation(
            ...
            "kahan_adamw8bit_e2e_shadow_training_mutated_original",
        ),
        _validation(
            "e2e_shadow_training_matrix_ready",
            matrix_ready,
            "kahan_adamw8bit_e2e_shadow_training_matrix_failed",
        ),
        _validation(
            ...
            "kahan_adamw8bit_e2e_shadow_training_enabled_dispatch",
        ),
        _validation(
            "default_behavior_unchanged",
            not bool(adapter.get("training_path_enabled", True))
            and not bool(adapter.get("default_behavior_changed", True)),
            "kahan_adamw8bit_e2e_shadow_training_changed_default_behavior",
        ),
    ]
...
__all__ = ["MATRIX_CASES", "MATRIX_KIND", "build_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard"]
