"""Optimizer training-step execution contract for TurboCore V5-P151."""
...
from core.turbocore_v5_optimizer_training_step_execution_specs_p151 import P151_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P151_READY_DECISION = SPEC.ready_decision
P151_BLOCKED_DECISION = SPEC.blocked_decision
P151_HOLD_DECISION = SPEC.hold_decision
P151_REJECTED_DECISION = SPEC.rejected_decision
P151_SCOPE = SPEC.scope
...
def build_v5_optimizer_training_step_execution_contract_p151(
    *,
    p150_optimizer_tensor_transfer_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p150_optimizer_tensor_transfer_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p150-optimizer-tensor-transfer-execution-contract")
    ...
    report = build_v5_optimizer_training_step_execution_contract_p151(
        p150_optimizer_tensor_transfer_execution_contract=_load_optional(
            args.p150_optimizer_tensor_transfer_execution_contract
        ),
        optimizer_training_step_execution_evidence=_load_optional(args.optimizer_training_step_execution_evidence),
        optimizer_training_step_execution_signed_review=_load_optional(args.optimizer_training_step_execution_signed_review),
    )
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_training_step_execution_contract_p151",
]
