"""Request/schema/UI non-exposure audit for built-in factored/custom canaries."""
...
AUDIT_KIND = "factored_custom_request_schema_ui_non_exposure_v0"
FORBIDDEN_BOUNDARY_TOKENS = (
    "factored_custom_native",
    "factored_custom_canary",
    "factored_custom_dispatch",
    "factored_custom_owner_release",
    "turbocore_factored_custom",
    "enable_factored_custom_kernel",
    "enable_factored_custom_native",
    "adafactor_native",
    "automagicpp_native",
    "anima_factored_adamw_native",
)
BOUNDARY_PATHS = (
...
def build_factored_custom_request_schema_ui_non_exposure_scorecard(
    *,
    ...
    hold_report = _as_dict(owner_release_hold_report or build_factored_custom_owner_release_hold_scorecard())
    ...
    report = {
        "schema_version": 1,
        "scorecard": "turbocore_factored_custom_request_schema_ui_non_exposure_scorecard_v0",
        "gate": "factored_custom_request_schema_ui_non_exposure",
        "ok": ready,
        ...
        "promotion_blockers": _dedupe(
            ...
            + [
                ...
                "factored_custom_request_schema_ui_exposure_not_approved",
                "factored_custom_product_dispatch_not_approved",
            ]
        ),
        "blocked_reasons": blockers,
        "recommended_next_step": (
            "record explicit owner and release approval before factored/custom request/schema/UI or dispatch wiring"
            if ready
            else "fix factored/custom request/schema/UI non-exposure blockers"
        ),
        "notes": [
            "This audit is report-only and does not register request fields, schema fields, UI controls, or routes.",
            "Boundary scanning checks product-facing paths for factored/custom native exposure tokens.",
...
def _validations(
    ...
    return [
        _validation(
            ...
            "factored_custom_owner_release_hold_missing",
        ),
        _validation(
            ...
            "factored_custom_request_schema_ui_unexpected_approval",
        ),
        _validation(
            ...
            "factored_custom_request_schema_ui_hold_enabled_boundary",
        ),
        _validation(
            "boundary_inventory_present",
            len(boundary.get("present_paths", [])) > 0,
            "factored_custom_request_schema_ui_boundary_inventory_missing",
        ),
        _validation(
            "forbidden_tokens_absent",
            not findings.get("forbidden_token_hits"),
            "factored_custom_request_schema_ui_forbidden_boundary_token_found",
        ),
    ]
...
__all__ = ["AUDIT_KIND", "build_factored_custom_request_schema_ui_non_exposure_scorecard"]
