"""Optimizer tensor-transfer execution contract for TurboCore V5-P150."""
...
from core.turbocore_v5_optimizer_tensor_transfer_execution_specs_p150 import P150_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P150_READY_DECISION = SPEC.ready_decision
P150_BLOCKED_DECISION = SPEC.blocked_decision
P150_HOLD_DECISION = SPEC.hold_decision
P150_REJECTED_DECISION = SPEC.rejected_decision
P150_SCOPE = SPEC.scope
...
def build_v5_optimizer_tensor_transfer_execution_contract_p150(
    *,
    p149_optimizer_parity_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p149_optimizer_parity_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p149-optimizer-parity-execution-contract")
    ...
    report = build_v5_optimizer_tensor_transfer_execution_contract_p150(
        p149_optimizer_parity_execution_contract=_load_optional(args.p149_optimizer_parity_execution_contract),
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_tensor_transfer_execution_contract_p150",
]
