"""Optimizer native-dispatch execution contract for TurboCore V5-P139."""
...
from core.turbocore_v5_optimizer_native_dispatch_execution_specs_p139 import P139_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P139_READY_DECISION = SPEC.ready_decision
P139_BLOCKED_DECISION = SPEC.blocked_decision
P139_HOLD_DECISION = SPEC.hold_decision
P139_REJECTED_DECISION = SPEC.rejected_decision
P139_SCOPE = SPEC.scope
...
def build_v5_optimizer_native_dispatch_execution_contract_p139(
    *,
    p138_optimizer_runtime_dispatch_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p138_optimizer_runtime_dispatch_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p138-optimizer-runtime-dispatch-execution-contract")
    ...
    report = build_v5_optimizer_native_dispatch_execution_contract_p139(
        p138_optimizer_runtime_dispatch_execution_contract=_load_optional(
            args.p138_optimizer_runtime_dispatch_execution_contract
        ),
