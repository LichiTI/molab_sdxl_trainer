"""Stage spec for optimizer runtime-dispatch execution contract P114."""

from __future__ import annotations

from core.turbocore_v5_optimizer_late_stage_contract_utils import OptimizerLateStageSpec
from core.turbocore_v5_optimizer_runtime_execution_preflight_specs_p113 import P113_SPEC
...
P114_SPEC = OptimizerLateStageSpec(
    stage_id=114,
    ...
    previous_label="P113 optimizer runtime-execution preflight contract",
    previous_ready_decision=P113_SPEC.ready_decision,
    ...
    previous_post_fields="post_p113_request_fields",
    previous_ack="acknowledge_p113_optimizer_runtime_execution_preflight_contract_recorded",
    ...
    required_sections=_sections(
        "p113_optimizer_runtime_execution_preflight_contract_reference",
    ...
    inherited_unsafe_true_fields=P113_SPEC.all_unsafe_true_fields,
    inherited_unsafe_non_empty_fields=P113_SPEC.all_unsafe_non_empty_fields,
)
