"""Smoke checks for Native Training Performance V2-P8AB audit."""
...
from devtools.audit_native_training_performance_p8ab import (  # noqa: E402
    build_p8ab_kahan_adamw8bit_e2e_shadow_matrix_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p8ab_kahan_adamw8bit_e2e_shadow_matrix_audit(quick=True)
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p8ab_audit_smoke",
        "ok": True,
