"""Smoke checks for Native Training Performance V2-P8AA audit."""
...
from devtools.audit_native_training_performance_p8aa import (  # noqa: E402
    build_p8aa_kahan_adamw8bit_runtime_adapter_shadow_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p8aa_kahan_adamw8bit_runtime_adapter_shadow_audit(quick=True)
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p8aa_audit_smoke",
        "ok": True,
