"""Smoke checks for Automagic++ training tensor binding canary."""
...
from core.turbocore_automagicpp_training_tensor_binding_canary_scorecard import (  # noqa: E402
    build_automagicpp_training_tensor_binding_canary_scorecard,
)


def run_smoke() -> dict[str, Any]:
    report = build_automagicpp_training_tensor_binding_canary_scorecard(workspace_root=REPO_ROOT)
    assert report["scorecard"] == "turbocore_automagicpp_training_tensor_binding_canary_scorecard_v0", report
    ...
    return {
        "schema_version": 1,
        "probe": "turbocore_automagicpp_training_tensor_binding_canary_scorecard_smoke",
        "ok": True,
