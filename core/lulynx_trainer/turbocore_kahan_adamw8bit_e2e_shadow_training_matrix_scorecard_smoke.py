"""Smoke checks for KahanAdamW8bit e2e shadow training matrix."""
...
from core.turbocore_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard import (  # noqa: E402
...
def run_smoke() -> dict[str, Any]:
    ...
    report = build_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard(
        run_live_probe=True,
    ...
    return {
        "schema_version": 1,
        "probe": "turbocore_kahan_adamw8bit_e2e_shadow_training_matrix_scorecard_smoke",
        "ok": True,
