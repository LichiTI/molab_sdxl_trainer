"""Training-launch boundary for T-LoRA A/B run-dispatch templates."""
...
def build_tlora_ab_training_launch_boundary(
    *,
    ...
    if boundary.get("scorecard") != "tlora_ab_run_dispatch_boundary_v0":
    ...
    return {
        "schema_version": 1,
        "scorecard": "tlora_ab_training_launch_boundary_v0",
        "ok": ready,
        ...
        "recommended_next_step": (
            ...
            if ready
            else "complete default-off T-LoRA training-launch boundary"
        ),
    }
...
__all__ = ["build_tlora_ab_training_launch_boundary"]
