"""Smoke checks for Automagic++ P32 explicit canary rollout policy."""
...
from core.turbocore_automagicpp_explicit_canary_rollout_policy_scorecard import (  # noqa: E402
    P31_AUDIT_BUILDER,
...
def run_smoke() -> dict[str, Any]:
    report = build_automagicpp_explicit_canary_rollout_policy_scorecard()
    ...
    assert report["p31_dependency"]["required_builder"] == P31_AUDIT_BUILDER, report
    assert report["p31_dependency"]["builder_name_recorded"] is True, report
    ...
    return {
        "schema_version": 1,
        "probe": "turbocore_automagicpp_explicit_canary_rollout_policy_scorecard_smoke",
        "ok": True,
        "summary": summary,
