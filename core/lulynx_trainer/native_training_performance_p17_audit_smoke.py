"""Smoke checks for Native Training Performance V2-P17 audit."""
...
from devtools.audit_native_training_performance_p17 import (  # noqa: E402
    build_p17_plugin_schedulefree_e2e_shadow_matrix_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p17_plugin_schedulefree_e2e_shadow_matrix_audit(native_training_mode="canary")
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p17_audit_smoke",
        "ok": True,
