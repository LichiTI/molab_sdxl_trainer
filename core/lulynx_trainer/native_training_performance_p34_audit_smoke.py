"""Smoke checks for Native Training Performance V2-P34 audit."""
...
from devtools.audit_native_training_performance_p34 import (  # noqa: E402
    build_p34_adafactor_native_scratch_kernel_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p34_adafactor_native_scratch_kernel_audit()
    ...
    assert gates["adafactor_native_kernel_parity"] is True, gates
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p34_audit_smoke",
        "ok": True,
