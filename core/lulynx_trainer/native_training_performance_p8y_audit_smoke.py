"""Smoke checks for Native Training Performance V2-P8Y audit."""
...
from devtools.audit_native_training_performance_p8y import (  # noqa: E402
    build_p8y_kahan_adamw8bit_real_training_matrix_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p8y_kahan_adamw8bit_real_training_matrix_audit(quick=True)
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p8y_audit_smoke",
        "ok": True,
