"""Smoke checks for Native Training Performance V2-P39 audit."""
...
from devtools.audit_native_training_performance_p39 import (  # noqa: E402
    build_p39_adafactor_explicit_canary_rollout_policy_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p39_adafactor_explicit_canary_rollout_policy_audit()
    gates = report["progress_gates"]
    assert report["ok"] is True, report
    assert report["milestone_completed"] is True, report
    assert gates["p38_e2e_shadow_matrix_dependency_named"] is True, gates
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p39_audit_smoke",
        "ok": True,
