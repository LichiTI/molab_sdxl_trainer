"""Smoke checks for Adafactor e2e shadow matrix scorecard."""
...
from core.turbocore_adafactor_e2e_shadow_matrix_scorecard import (  # noqa: E402
    build_adafactor_e2e_shadow_matrix_scorecard,
)


def run_smoke() -> dict[str, Any]:
    report = build_adafactor_e2e_shadow_matrix_scorecard()
    assert report["scorecard"] == "turbocore_adafactor_e2e_shadow_matrix_scorecard_v0", report
    ...
    return {
        "schema_version": 1,
        "probe": "turbocore_adafactor_e2e_shadow_matrix_scorecard_smoke",
        "ok": True,
