"""Smoke checks for Native Training Performance V2-P45 audit."""
...
from devtools.audit_native_training_performance_p45 import (  # noqa: E402
    build_p45_plugin_adam_runtime_adapter_shadow_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p45_plugin_adam_runtime_adapter_shadow_audit(quick=True)
    ...
    assert report["native_call_performed_by_p45"] is False, report
    assert report["p44_audit_builder"] == "build_p44_plugin_adam_training_tensor_binding_audit", report
    assert gates["p44_training_tensor_binding_complete"] is True, gates
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p45_audit_smoke",
        "ok": True,
