"""Smoke checks for Native Training Performance V2-P8L audit."""
...
from devtools.audit_native_training_performance_p8l import (  # noqa: E402
    build_p8l_paged_adamw8bit_training_tensor_binding_canary_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p8l_paged_adamw8bit_training_tensor_binding_canary_audit(quick=True)
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p8l_audit_smoke",
        "ok": True,
