"""Smoke checks for Native Training Performance V2-p57 audit."""
...
from devtools.audit_native_training_performance_p57 import (  # noqa: E402
    build_p57_plugin_adamg_runtime_adapter_shadow_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p57_plugin_adamg_runtime_adapter_shadow_audit(quick=True)
    ...
    assert report["native_call_performed_by_p57"] is False, report
    assert report["p56_audit_builder"] == "build_p56_plugin_adamg_training_tensor_binding_audit", report
    assert gates["p56_training_tensor_binding_complete"] is True, gates
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p57_audit_smoke",
        "ok": True,
