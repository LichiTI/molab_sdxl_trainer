...
"""Standalone smoke tests for Anima cache generation with Qwen3/T5/LLM adapter support.
...
This is a standalone version that imports only the minimal required modules.
"""
...
def test_cache_builder_qwen3_t5_fields():
    ...
    # Direct import to avoid full trainer initialization
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("[PASS] Cache builder writes Qwen3/T5 fields correctly")
...
def test_cache_builder_token_limits():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("[PASS] Token limits applied correctly during cache generation")
...
def test_online_cache_dataset_generation():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("[PASS] Online cache dataset generates and reuses cache correctly")
...
def test_cache_metadata_schema_version():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("[PASS] Cache metadata includes schema version and has_loss_mask")
...
if __name__ == "__main__":
    ...
    print("\n[PASS] All Phase 5 cache generation smoke tests passed")
