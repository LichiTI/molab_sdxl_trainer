"""Smoke checks for selected plugin Adam-like canary rollout policy."""
...
from core.turbocore_plugin_adamlike_canary_rollout_policy_scorecard import (  # noqa: E402
    build_plugin_adamlike_canary_rollout_policy_scorecard,
)


def run_smoke() -> dict[str, Any]:
    report = build_plugin_adamlike_canary_rollout_policy_scorecard(
    ...
    assert report["scorecard"] == "turbocore_plugin_adamlike_canary_rollout_policy_scorecard_v0", report
    ...
    return {
        "schema_version": 1,
        "probe": "turbocore_plugin_adamlike_canary_rollout_policy_scorecard_smoke",
        "ok": True,
