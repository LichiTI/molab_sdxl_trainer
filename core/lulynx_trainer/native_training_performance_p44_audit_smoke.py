"""Smoke checks for Native Training Performance V2-P44 audit."""
...
from devtools.audit_native_training_performance_p44 import (  # noqa: E402
    build_p44_plugin_adam_training_tensor_binding_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p44_plugin_adam_training_tensor_binding_audit()
    gates = report["progress_gates"]
    assert report["ok"] is True, report
    assert report["milestone_completed"] is True, report
    assert gates["p43_adam_scratch_kernel_complete"] is True, gates
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p44_audit_smoke",
        "ok": True,
