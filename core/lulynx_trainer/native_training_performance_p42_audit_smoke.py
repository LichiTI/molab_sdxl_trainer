"""Smoke checks for Native Training Performance V2-P42 audit."""
...
from devtools.audit_native_training_performance_p42 import (  # noqa: E402
    build_p42_plugin_adamw_training_loop_canary_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p42_plugin_adamw_training_loop_canary_audit()
    ...
    assert gates["selected_adamw_is_compatible"] is True, gates
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p42_audit_smoke",
        "ok": True,
