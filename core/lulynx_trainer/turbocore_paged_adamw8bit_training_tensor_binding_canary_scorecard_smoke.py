"""Smoke checks for PagedAdamW8bit training tensor binding canary."""
...
from core.turbocore_paged_adamw8bit_training_tensor_binding_canary_scorecard import (  # noqa: E402
    ENTRYPOINT,
...
def run_smoke() -> dict[str, Any]:
    report = build_paged_adamw8bit_training_tensor_binding_canary_scorecard(run_live_probe=True)
    ...
    return {
        "schema_version": 1,
        "probe": "turbocore_paged_adamw8bit_training_tensor_binding_canary_scorecard_smoke",
        "ok": True,
