"""Operator launch-review boundary for T-LoRA A/B training-launch templates."""
...
def build_tlora_ab_operator_training_launch_boundary(
    *,
    ...
    if boundary.get("scorecard") != "tlora_ab_training_launch_boundary_v0":
    ...
    return {
        "schema_version": 1,
        "scorecard": "tlora_ab_operator_training_launch_boundary_v0",
        "ok": ready,
        ...
        "recommended_next_step": (
            "hold for explicit route decision before any T-LoRA training execution contract"
            if ready
            else "complete default-off T-LoRA operator training-launch boundary"
        ),
    }
...
__all__ = ["build_tlora_ab_operator_training_launch_boundary"]
