"""Smoke checks for Native Training Performance V2-P53 audit."""
...
from devtools.audit_native_training_performance_p53 import (  # noqa: E402
    build_p53_plugin_adamc_runtime_adapter_shadow_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p53_plugin_adamc_runtime_adapter_shadow_audit(quick=True)
    ...
    assert report["native_call_performed_by_p53"] is False, report
    assert report["p52_audit_builder"] == "build_p52_plugin_adamc_training_tensor_binding_audit", report
    assert gates["p52_training_tensor_binding_complete"] is True, gates
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p53_audit_smoke",
        "ok": True,
