"""Smoke checks for Native Training Performance V2-P30 audit."""
...
from devtools.audit_native_training_performance_p30 import (  # noqa: E402
    build_p30_anima_factored_adamw_real_dispatch_integration_review_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p30_anima_factored_adamw_real_dispatch_integration_review_audit(quick=True)
    ...
    assert report["native_call_performed_by_p30"] is False, report
    assert report["p29_audit_builder"] == P29_AUDIT_BUILDER, report
    ...
    assert gates["p29_explicit_canary_rollout_policy_dependency_named"] is True, gates
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p30_audit_smoke",
        "ok": True,
