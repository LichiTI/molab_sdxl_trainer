"""Smoke checks for Native Training Performance V2-P8R audit."""
...
from devtools.audit_native_training_performance_p8r import (  # noqa: E402
    build_p8r_paged_adamw8bit_canary_rollout_policy_audit,
)


def run_smoke() -> dict[str, Any]:
    report = build_p8r_paged_adamw8bit_canary_rollout_policy_audit(quick=True)
    ...
    return {
        "schema_version": 1,
        "probe": "native_training_performance_p8r_audit_smoke",
        "ok": True,
