"""Optimizer runtime-execution preflight contract for TurboCore V5-P121."""
...
from core.turbocore_v5_optimizer_runtime_execution_preflight_specs_p121 import P121_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P121_READY_DECISION = SPEC.ready_decision
P121_BLOCKED_DECISION = SPEC.blocked_decision
P121_HOLD_DECISION = SPEC.hold_decision
P121_REJECTED_DECISION = SPEC.rejected_decision
P121_SCOPE = SPEC.scope
...
def build_v5_optimizer_runtime_execution_preflight_contract_p121(
    *,
    p120_optimizer_training_launch_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p120_optimizer_training_launch_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p120-optimizer-training-launch-execution-contract")
    ...
    report = build_v5_optimizer_runtime_execution_preflight_contract_p121(
        p120_optimizer_training_launch_execution_contract=_load_optional(
            args.p120_optimizer_training_launch_execution_contract
        ),
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_runtime_execution_preflight_contract_p121",
]
