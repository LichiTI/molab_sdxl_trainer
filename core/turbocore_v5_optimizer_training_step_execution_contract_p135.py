"""Optimizer training-step execution contract for TurboCore V5-P135."""
...
from core.turbocore_v5_optimizer_training_step_execution_specs_p135 import P135_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P135_READY_DECISION = SPEC.ready_decision
P135_BLOCKED_DECISION = SPEC.blocked_decision
P135_HOLD_DECISION = SPEC.hold_decision
P135_REJECTED_DECISION = SPEC.rejected_decision
P135_SCOPE = SPEC.scope
...
def build_v5_optimizer_training_step_execution_contract_p135(
    *,
    p134_optimizer_tensor_transfer_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p134_optimizer_tensor_transfer_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p134-optimizer-tensor-transfer-execution-contract")
    ...
    report = build_v5_optimizer_training_step_execution_contract_p135(
        p134_optimizer_tensor_transfer_execution_contract=_load_optional(
            args.p134_optimizer_tensor_transfer_execution_contract
        ),
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_training_step_execution_contract_p135",
]
