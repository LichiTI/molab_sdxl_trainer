"""Stage spec for optimizer runtime-execution preflight contract P105."""

from __future__ import annotations

from core.turbocore_v5_optimizer_late_stage_contract_utils import OptimizerLateStageSpec
from core.turbocore_v5_optimizer_training_launch_execution_specs_p104 import P104_SPEC
...
P105_SPEC = OptimizerLateStageSpec(
    stage_id=105,
    ...
    previous_label="P104 optimizer training-launch execution contract",
    previous_ready_decision=P104_SPEC.ready_decision,
    ...
    previous_post_fields="post_p104_request_fields",
    previous_ack="acknowledge_p104_optimizer_training_launch_execution_contract_recorded",
    ...
    required_sections=_sections(
        "p104_optimizer_training_launch_execution_contract_reference",
    ...
    inherited_unsafe_true_fields=P104_SPEC.all_unsafe_true_fields,
    inherited_unsafe_non_empty_fields=P104_SPEC.all_unsafe_non_empty_fields,
)
