"""Optimizer training-step execution contract for TurboCore V5-P127."""
...
from core.turbocore_v5_optimizer_training_step_execution_specs_p127 import P127_SPEC as SPEC
from core.turbocore_v5_owner_review_evidence_package import load_json

P127_READY_DECISION = SPEC.ready_decision
P127_BLOCKED_DECISION = SPEC.blocked_decision
P127_HOLD_DECISION = SPEC.hold_decision
P127_REJECTED_DECISION = SPEC.rejected_decision
P127_SCOPE = SPEC.scope
...
def build_v5_optimizer_training_step_execution_contract_p127(
    *,
    p126_optimizer_tensor_transfer_execution_contract: Mapping[str, Any] | None = None,
    ...
    return build_optimizer_late_stage_contract(
        SPEC,
        previous_contract=p126_optimizer_tensor_transfer_execution_contract,
...
def _main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--p126-optimizer-tensor-transfer-execution-contract")
    ...
    report = build_v5_optimizer_training_step_execution_contract_p127(
        p126_optimizer_tensor_transfer_execution_contract=_load_optional(
            args.p126_optimizer_tensor_transfer_execution_contract
        ),
...
__all__ = [
    ...
    "UNSAFE_TRUE_FIELDS",
    "build_v5_optimizer_training_step_execution_contract_p127",
]
