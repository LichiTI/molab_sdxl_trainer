"""Stage spec for optimizer native-dispatch execution contract P107."""

from __future__ import annotations

from core.turbocore_v5_optimizer_late_stage_contract_utils import OptimizerLateStageSpec
from core.turbocore_v5_optimizer_runtime_dispatch_execution_specs_p106 import P106_SPEC
...
P107_SPEC = OptimizerLateStageSpec(
    stage_id=107,
    ...
    previous_label="P106 optimizer runtime-dispatch execution contract",
    previous_ready_decision=P106_SPEC.ready_decision,
    ...
    previous_post_fields="post_p106_request_fields",
    previous_ack="acknowledge_p106_optimizer_runtime_dispatch_execution_contract_recorded",
    ...
    required_sections=_sections(
        "p106_optimizer_runtime_dispatch_execution_contract_reference",
    ...
    inherited_unsafe_true_fields=P106_SPEC.all_unsafe_true_fields,
    inherited_unsafe_non_empty_fields=P106_SPEC.all_unsafe_non_empty_fields,
)
